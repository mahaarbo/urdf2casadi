...
pr2 = u2c.URDFparser()
pr2.from_file("/home/lillmaria/urdf2casadi/examples/urdf/pr2.urdf")
...
qddot_sym_aba = pr2.get_forward_dynamics_aba(root, tip, gravity = gravity)
qddot_sym_crba = pr2.get_forward_dynamics_crba(root, tip, gravity = gravity)
